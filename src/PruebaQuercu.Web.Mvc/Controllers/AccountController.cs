...
using PruebaQuercu.Web.Models.Account;
using PruebaQuercu.Web.Views.Shared.Components.TenantChange;
...
public class AccountController : PruebaQuercuControllerBase
{
