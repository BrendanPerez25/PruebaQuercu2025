...
namespace PruebaQuercu.Migrations
{
    ...
    [Migration("20250722151350_PruebaQuercu")]
    partial class PruebaQuercu
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("PruebaQuercu.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("PruebaQuercu.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("PruebaQuercu.Property.TaskProperty", b =>
                {
                    ...
                    b.HasOne("PruebaQuercu.PropertyType.TaskPropertyType", "PropertyType")
                        .WithMany("Propertys")
