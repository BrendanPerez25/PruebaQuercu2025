...
public class DefaultLanguagesCreator
{
    ...
    {
        var tenantId = PruebaQuercuConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
    ...
    public DefaultLanguagesCreator(PruebaQuercuDbContext context)
    {
        _context = context;
    }
