...
public abstract class PruebaQuercuWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static PruebaQuercuWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(PruebaQuercuWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<PruebaQuercuDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<PruebaQuercuDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<PruebaQuercuDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<PruebaQuercuDbContext, Task<T>> func)
    {
        T result;
